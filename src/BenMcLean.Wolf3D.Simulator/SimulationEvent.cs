...
/// <summary>
/// Eight-way direction enum for Wolf3D actors.
/// Enum values (0-7) match sprite rotation offsets for rotated sprites.
/// WL_DEF.H:dirtype - original used nodir, east, northeast, north, northwest, west, southwest, south, southeast
/// </summary>
public enum Direction : byte
{
	/// <summary>East - 0 degrees, facing +X in Wolf3D coordinates</summary>
	E = 0,
	/// <summary>Northeast - 45 degrees</summary>
	NE = 1,
	/// <summary>North - 90 degrees, facing +Y in Wolf3D coordinates</summary>
	N = 2,
	/// <summary>Northwest - 135 degrees</summary>
	NW = 3,
	/// <summary>West - 180 degrees, facing -X in Wolf3D coordinates</summary>
	W = 4,
	/// <summary>Southwest - 225 degrees</summary>
	SW = 5,
	/// <summary>South - 270 degrees, facing -Y in Wolf3D coordinates</summary>
	S = 6,
	/// <summary>Southeast - 315 degrees</summary>
	SE = 7
}
...
/// </summary>
public struct ActorSpawnedEvent : ISimulationEvent
{
	public required double Timestamp { get; init; }
...
/// </summary>
public struct ActorMovedEvent : ISimulationEvent
{
	public required double Timestamp { get; init; }
	public required int ActorIndex { get; init; }
...
/// </summary>
public struct ActorSpriteChangedEvent : ISimulationEvent
{
	public required double Timestamp { get; init; }
	public required int ActorIndex { get; init; }
...
/// </summary>
public struct ActorDespawnedEvent : ISimulationEvent
{
	public required double Timestamp { get; init; }
	public required int ActorIndex { get; init; }
